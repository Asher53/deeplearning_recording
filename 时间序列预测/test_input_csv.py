...
# import pandas as pd
# df = pd.read_excel(r'/Users/xiaoliang/Desktop/mycode/deep_learning/15_lstm_study/period_trend.xls', header=None)
# df['A'], df['B'] = df[0].str.split(',', 1).str
# df.drop(0, axis=1, inplace=True)
# df.to_csv('period_trend.csv', index=False, header=None)
